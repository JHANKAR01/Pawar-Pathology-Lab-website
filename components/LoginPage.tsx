...
import { Mail, Lock, Loader2, AlertCircle, FlaskConical, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center p-4">
      ...
      <div className="w-full max-w-md bg-white rounded-[2.5rem] shadow-2xl border border-gray-100 overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div className="bg-red-600 p-10 text-center relative overflow-hidden">
          ...
          <h2 className="text-2xl font-black text-white uppercase tracking-tight">Portal Login</h2>
          <p className="text-red-100 text-sm font-medium mt-1">Admin & Partners Authorized Access</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="p-10 space-y-6">
          ...
          <div>
            <label className="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2">User ID / Email</label>
            <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-12 pr-4 py-4 bg-gray-50 border-0 rounded-2xl focus:ring-2 focus:ring-red-500 outline-none transition-all font-medium"
                value={email}
          ...
          <div className="pt-4 text-center">
            <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">
              Secured by Pawar Pathology Cloud
            </p>
          </div>
        </form>
      </div>
