    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <nav className="bg-white border-b px-6 py-4 flex justify-between items-center sticky top-0 z-50">
        <div className="flex items-center gap-2">
          ...
          <h1 className="font-bold text-lg">Partner Portal | Betul</h1>
        </div>
      ...
      <main className="p-6 max-w-4xl mx-auto w-full">
        <header className="mb-8">
          <h2 className="text-2xl font-black text-gray-900">Partner Assignments</h2>
          <p className="text-gray-500 font-medium">Daily collection and diagnostic tasks</p>
        </header>
        ...
        <div className="space-y-4">
          {tasks.length === 0 ? (
            <div className="text-center py-20 bg-white rounded-3xl border-2 border-dashed border-gray-100">
              ...
              <p className="text-gray-400 font-bold">No active assignments.</p>
            </div>
          ) : (
            tasks.map(task => (
                ...
                <div className="flex flex-col md:flex-row justify-between gap-6">
                  <div className="flex-1">
                    ...
                    <div className="space-y-2 text-sm text-gray-600">
                      <p className="flex items-center gap-2"><MapPin className="text-red-500 w-4 h-4" /> Betul Area (Collection)</p>
                      <p className="flex items-center gap-2"><Phone className="text-green-500 w-4 h-4" /> +91 Contact</p>
                    </div>
                  </div>
